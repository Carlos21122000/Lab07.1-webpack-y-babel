...
import foto1 from '../multimedia/img100.jpg';
import foto2 from '../multimedia/imagen1.jpg';
...
const titulo = document.createTextNode("UN VIAJE DE LOCOS");
h1.appendChild(titulo);

const h4 = document.createElement("h4");
const texto1 = document.createTextNode("Bienvenidos a mi pagina, donde encontraran unas historia basada en hechos reales. 100 por ciento real no fake");
...
const main_div = document.createElement("div");
	...
	image0.src = foto1;
	image0.atl = "imagen1";
	image0.style.width = "350px";
	image0.style.height = "350px";
	image0.style.display="block";
	image0.style.margin = "auto";
	main_div.appendChild(image0);
	
	const br2_texto = document.createElement("br");
	main_div.appendChild(br2_texto);
	
	const parrafo = document.createElement("p");
	const contenido = document.createTextNode("Introduccion Estas es una historia basada en hechos reales, esta historia trata sobre mi viaje a los Estados Unidos el 2018 y todas las aventuras, problemas momentos alegres que vivi en ese viaje. entonces preparen sus palomitas que arrancamos");
	main_div.appendChild(contenido);
	
	const br4_texto = document.createElement("br");
	main_div.appendChild(br4_texto);
	...
	const contenido1 = document.createTextNode("te esta pareciendo interesante? continua leyendo al precionar las opciones del menu desplegable");
	marquee1.style.width = "500";
	marquee1.style.scrollamount = "5"
	marquee1.appendChild(contenido1);
	div_1.appendChild(marquee1);
	main_div.appendChild(marquee1);
	
const label = document.createElement("label");
label.id = "pagina";
label.innerText = "Pagina principal  \t";
