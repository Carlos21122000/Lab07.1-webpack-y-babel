...
var _img = _interopRequireDefault(require("../multimedia/img26.jpeg"));
...
const titulo = document.createTextNode("ESTADIO DEL LAFC");
h1.appendChild(titulo);
const h4 = document.createElement("h4");
const texto1 = document.createTextNode("LAFC");
...
figcaption1.textContent = "Fig.12 - Exposition Park neighborhood of Los Angeles, California USA";
figcaption1.style.color = "white";
figure1.appendChild(figcaption1);
main_div.appendChild(figure1);
const parrafo = document.createElement("p");
const contenido = document.createTextNode("lastimosamente no habia partido el dia que fuimos pero tuvimos la oportunidad de conocer el estadio y tomarnos algunas fotos. EL estadio es muy bonito, se alcanzaba a ver todo el campo desde la entrada y es imprecionante la infraestructura que hay en Estados Unidos.");
