...
var _img = _interopRequireDefault(require("../multimedia/img.jpeg"));

var _avion = _interopRequireDefault(require("../Multimedia/avion.mp3"));
...
const titulo = document.createTextNode("LLEGADA AL AEREOPUERTO");
h1.appendChild(titulo);
const h4 = document.createElement("h4");
const texto1 = document.createTextNode("casi perdemos el vuelo");
h4.appendChild(texto1);
const main_div = document.createElement("div");
const figure1 = document.createElement("figure");
const image1 = document.createElement("img");
image1.src = _img.default;
image1.atl = "Aereopuerto";
...
figcaption1.textContent = "Fig.1 - Aereopuerto La Aurora, Guatemala, Guatemala.";
figcaption1.style.color = "white";
figure1.appendChild(figcaption1);
main_div.appendChild(figure1);
const parrafo = document.createElement("p");
const contenido = document.createTextNode("El dia en que salia el vuelo, mi papa le toco ir a trabajar medio dia, y mi hermana y yo estabamos en el colegio. En ese tiempo, yo tenia examenes finales y me tocaba el de quimica, yo termine un poco tarde el examen y por eso habia retrasado un poco la hora de llegada, salimos del colegio y habia un trafico que ufff y todo por un accidente, mi papa nos llamo todo preocupado que porque aun no habiamos llegado al aereopuerto, y al cabo que llegamos 1 hora antes de que saliera el vuelo, logramos pasar todo y subirnos en el avion a tiempo");
parrafo.appendChild(contenido);
const audio = document.createElement("audio");
audio.controls = true;
const source = document.createElement("source");
source.src = _avion.default;
...
a_1.href = "http://www.dgac.gob.gt/index.php/141-dgac-firma-importante-convenio";
a_1.innerText = "aereopuero internacion la aurora";
