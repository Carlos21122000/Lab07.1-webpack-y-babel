...
var _img = _interopRequireDefault(require("../multimedia/img4.jpeg"));

var _img2 = _interopRequireDefault(require("../multimedia/img5.jpeg"));

var _img3 = _interopRequireDefault(require("../multimedia/img3.jpeg"));
...
const titulo = document.createTextNode("ESTANDO EN SAN FRANCISCO");
h1.appendChild(titulo);
const h4 = document.createElement("h4");
const texto1 = document.createTextNode("Que hice en San francisco?");
...
figcaption1.textContent = "Fig.4 - San Francisco, California, USA.";
...
const contenido = document.createTextNode("Conoci el acuario de san francisco donde tenian una cantidad inmensa de peces y animales marino, tambien tenian una seccion subterranea donde los peces pasaban por encima");
...
const contenido1 = document.createTextNode("Dimos vueltas por la ciudad de SF en los entrenes que estan por la ciudad");
...
a_1.href = "https://sf.gov/";
a_1.innerText = "San Francisco";
Li_1.appendChild(a_1);
Lista1.appendChild(Li_1);
const Li_2 = document.createElement("li");
const a_2 = document.createElement("a");
a_2.href = "https://www.aquariumofthebay.org/";
a_2.innerText = "Acuario";
